	...
	function select(req,res){
		...
		switch(req.url){
			...
			case '/addChapter/':
			  ...
			  break;
			default:
				var cname1 = req.url.split('?')[0];
				var cname = cname1.split('/');
				if(cname.length>3){
				for(var a = 2;a<cname.length;a++){
				  var  b= '/'+cname[a];
				  file += b;
				}
				// log("jhhh"+file);
				...
				else if(cname[1]=="chapter.html"){
				for(var a =0;a<cname.length;a++){
					var  b= '/'+cname[a];
					file += b;
				  }
				}
				else if(cname[1]=="detail"){
					var q = query1.split('=');
					var q1 = q[1];
					q = JSON.stringify(chapterList[q1-1]);
					res.writeHead(200,{
